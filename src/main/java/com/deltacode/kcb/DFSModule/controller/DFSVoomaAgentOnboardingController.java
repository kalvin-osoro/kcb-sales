...
import com.deltacode.kcb.service.*;
...
@RestController("/api/dfs/vooma-agent")
public class DFSVoomaAgentOnboardingController {
    @Autowired
    ...
    @PostMapping("/create-vooma-agent-account")
...
//    }
    ...
    @GetMapping("fileupload/dfs-agent/{filename:.+}")
    @ResponseBody
    ...
    @GetMapping("fileupload2/dfs-agent/{filename:.+}")
    @ResponseBody
