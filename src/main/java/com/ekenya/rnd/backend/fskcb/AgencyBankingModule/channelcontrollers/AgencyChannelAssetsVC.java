...
public class AgencyChannelAssetsVC {
    ...
    public ResponseEntity<?> assignAsset(@RequestBody AgencyAssignAssetRequest request) {
...
//          node.put("id",0);
    ...
    public ResponseEntity<?> recollectAsset(@RequestBody AgencyCollectAssetRequest request) {
