...
//          node.put("id",0);
    ...
    @RequestMapping(value = "/treasury-customer-visits-summary", method = RequestMethod.GET)
    public ResponseEntity<?> getCustomerVisitsSummary(@RequestBody TreasurySummaryRequest filters) {
...
//          node.put("id",0);
    ...
    @RequestMapping(value = "/treasury-targets-summary", method = RequestMethod.GET)
...
//          node.put("id",0);
    ...
    @RequestMapping(value = "/treasury-leads-summary", method = RequestMethod.GET)
...
//          node.put("id",0);
    ...
    @RequestMapping(value = "/treasury-assets-summary", method = RequestMethod.GET)
    public ResponseEntity<?> getAssetsSummary(@RequestBody TreasurySummaryRequest filters) {
