...
//          node.put("id",0);
    ...
    @PostMapping("/cb-add-customer-visit-report")
    public ResponseEntity<?> addCustomerVisitReport(@RequestBody CBCustomerVisitReportRequest request) {
...
//          node.put("id",0);
    ...
    @PostMapping(value = "/cb-get-all-customer-opportunities")
    public ResponseEntity<?> getAllCustomerVisitOpportunities(@RequestBody String customerId) {
...
//          node.put("id",0);
    ...
    @PostMapping("/cb-create-customer-appointment")
    public ResponseEntity<?> createCustomerAppointment(@RequestBody CBAddCustomerAppointmentRequest request) {
...
//          node.put("id",0);
    ...
    @PostMapping(value = "/cb-get-all-customer-appointments")
    public ResponseEntity<?> getAllCustomerVisitAppointments(@RequestBody String customerId) {
